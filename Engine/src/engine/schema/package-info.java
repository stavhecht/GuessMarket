 ...
 * (a commission within range, exactly two options, unique ids, a market maker for an
 * event that exists) is {@code engine.loader.XmlEventLoader}'s decision, which is also the
